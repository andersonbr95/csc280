...
public class MinPQ implements HeapInterface {
    ...
    public MinPQ() {
        this.heap = new ArrayList<>(); // we aren't using List here because the List library is an interface while ArrayList is a concrete class //ArrayList is implemented using List anyways and by using List, we get access to the methods provided by List
    }
